...
Script Purpose:
===============================================================================
This script performs data quality and validation checks on the cleaned
sales_details and vehicle_info tables to ensure the data is accurate,
consistent, complete, and reliable for further analysis.

Validation checks include:
    1. Table structure and column validation
    2. NULL value checks
    3. Duplicate record checks
    4. Leading and trailing space checks
    5. Blank value checks
    6. Inconsistent categorical value checks
    7. Invalid numeric value checks
    8. Invalid date checks
    9. Data type validation
   10. Orphan record checks between related tables

These checks help identify potential data quality issues and ensure that the
datasets are reliable and analysis-ready before proceeding with sales analysis
